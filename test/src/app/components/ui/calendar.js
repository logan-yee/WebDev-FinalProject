  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-white bg-neutral-800 rounded-md w-8 font-normal text-[0.8rem]",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal text-white aria-selected:bg-zinc-500"
        ),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected:
          "bg-blue-600 text-white hover:bg-blue-500 focus:bg-zinc-500",
        day_today: "bg-neutral-700 text-white",
        day_outside: "day-outside text-gray-500",
        day_disabled: "text-gray-500 opacity-50",
        day_range_middle: "bg-neutral-600 text-white",
